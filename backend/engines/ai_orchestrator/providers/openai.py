...
class OpenAIProvider(BaseAIProvider):
    ...
    Ce fournisseur implémente l'interface avec l'API OpenAI.
    """
    
    def __init__(self, config: Optional[AIProviderConfig] = None):
        """Initialiser le fournisseur OpenAI."""
        if config is None:
        ...
        self.api_url = config.api_url or settings.openai_api_url
    ...
    async def execute(
        ...
        **kwargs,
        ...
        """
        Exécuter une requête IA avec OpenAI.
        ...
        try:
            ...
            endpoint = self._get_api_endpoint(request.model_type)
    ...
    def _prepare_request_data(self, request: AIRequest) -> Dict[str, Any]:
        """Préparer les données de la requête pour l'API OpenAI."""
